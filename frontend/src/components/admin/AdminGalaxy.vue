...
const syncUniforms = () => {
  ...
  program.uniforms.uFocal.value = new Float32Array(props.focal)
  program.uniforms.uRotation.value = new Float32Array(props.rotation)
  ...
  program.uniforms.uMouseRepulsion.value = props.mouseRepulsion
  program.uniforms.uTwinkleIntensity.value = props.twinkleIntensity
  program.uniforms.uRotationSpeed.value = props.rotationSpeed
  program.uniforms.uRepulsionStrength.value = props.repulsionStrength
  program.uniforms.uAutoCenterRepulsion.value = props.autoCenterRepulsion
  program.uniforms.uTransparent.value = props.transparent
}

const bindMouse = () => {
  const container = containerRef.value
  if (!container || !props.mouseInteraction) return
...
onMounted(() => {
  ...
  program = new Program(gl, {
    ...
    uniforms: {
      ...
      uFocal: {
        value: new Float32Array(props.focal)
      },
      uRotation: {
        value: new Float32Array(props.rotation)
      },
      uStarSpeed: {
        value: props.starSpeed
      },
      uDensity: {
        value: props.density
      },
      ...
      uMouseRepulsion: {
        value: props.mouseRepulsion
      },
      uTwinkleIntensity: {
        value: props.twinkleIntensity
      },
      uRotationSpeed: {
        value: props.rotationSpeed
      },
      uRepulsionStrength: {
        value: props.repulsionStrength
      },
      uMouseActiveFactor: {
        value: 0
      },
      uAutoCenterRepulsion: {
        value: props.autoCenterRepulsion
      },
      uTransparent: {
...
onBeforeUnmount(() => {
  ...
  if (canvas && canvas.parentElement === containerRef.value) {
